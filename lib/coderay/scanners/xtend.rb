...
module Scanners
  ...
  class Xtend < Scanner
    ...
    include Streamable
    register_for :xtend
    require 'coderay/scanners/xtend/builtin_types'
    ...
    KEYWORDS = %w[
      ...
      debugger export def val var typeof
    ]
    RESERVED = %w[ const goto ]
    CONSTANTS = %w[ false null true ]
    MAGIC_VARIABLES = %w[ this super it ]
    TYPES = %w[
    ...
    DIRECTIVES = %w[
      ...
      static strictfp synchronized throws transient volatile override dispatch create
    ]
